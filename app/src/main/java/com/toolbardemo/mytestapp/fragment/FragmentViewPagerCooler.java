...
public class FragmentViewPagerCooler extends Fragment {
    ...
    public FragmentViewPagerCooler newInstance(CustomRecyclerStock adapter){
        Log.d(TAG, "newInstance");
        FragmentViewPagerCooler fragment = new FragmentViewPagerCooler();

...
public class FragmentViewPagerFridge extends Fragment {
    ...
    public FragmentViewPagerFridge newInstance(CustomRecyclerStock adapter){
        Log.d(TAG, "newInstance");
        FragmentViewPagerFridge fragment = new FragmentViewPagerFridge();

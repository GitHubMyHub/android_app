...
public class CustomListIngredientFilter_all extends RecyclerView.Adapter<CustomListIngredientFilter_all.MyViewHolder>{
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        @BindView(R.id.txtViewTextIngredientFilterId) TextView txtViewTextIngredientFilterId;
        @BindView(R.id.txtViewTextIngredientFilterName) TextView txtViewTextIngredientFilterName;
        @BindView(R.id.txtViewTextIngredientFilterIdFk) TextView txtViewTextIngredientFilterIdFk;
        @BindView(R.id.txtViewTextIngredientFilterUserId) TextView txtViewTextIngredientFilterUserId;
        @BindView(R.id.txtViewTextIngredientFilterComponents) TextView txtViewTextIngredientFilterComponents;
    ...
    public CustomListIngredientFilter_all(AdapterCallback callback, Context context, ArrayList<IngredientFilter> data){
    ...
    @Override
    public CustomListIngredientFilter_all.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                          int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_single_ingredient_filter_all, parent, false);
        Log.d("onCreateViewHolder", "JA");

        return new CustomListIngredientFilter_all.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CustomListIngredientFilter_all.MyViewHolder holder, final int listPosition) {
        Log.d("onBindViewHolder", holder.toString());

        // Ingredient-Filters-ID
        TextView txtViewTextIngredientFilterId = holder.txtViewTextIngredientFilterId;
        txtViewTextIngredientFilterId.setText(String.valueOf(web.get(listPosition).getFilterId()));

        // Ingredient-Filter-ID->FK (ingredient_FilterS
        TextView txtViewTextIngredientFilterIdFk = holder.txtViewTextIngredientFilterIdFk;
        txtViewTextIngredientFilterIdFk.setText(String.valueOf(web.get(listPosition).getFilters_id_fk()));

        // Ingredient-Filters-User-ID
        TextView txtViewTextIngredientFiltersUserId = holder.txtViewTextIngredientFilterUserId;
        txtViewTextIngredientFiltersUserId.setText(web.get(listPosition).getUserId());

        // Ingredient-Filters-Status
        TextView txtViewTextIngredientFiltersStatus = holder.txtViewTextIngredientFilterComponents;
        txtViewTextIngredientFiltersStatus.setText(String.valueOf(web.get(listPosition).getComponentsIdFk()));
